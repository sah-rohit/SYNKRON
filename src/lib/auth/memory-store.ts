/**
 * SYNKRON In-Memory Session + User Store
 *
...
declare global {
  ...
  var __synkron_users: Map<string, MemUser> | undefined;
  // eslint-disable-next-line no-var
  var __synkron_usersByEmail: Map<string, string> | undefined;
  // eslint-disable-next-line no-var
  var __synkron_usersByUsername: Map<string, string> | undefined;
  // eslint-disable-next-line no-var
  var __synkron_sessions: Map<string, MemSession> | undefined;
  // eslint-disable-next-line no-var
  var __synkron_aiUsage: Map<string, { count: number; weekStart: number }> | undefined;
}

const users: Map<string, MemUser> =
  (globalThis.__synkron_users ??= new Map());
const usersByEmail: Map<string, string> =
  (globalThis.__synkron_usersByEmail ??= new Map());
const usersByUsername: Map<string, string> =
  (globalThis.__synkron_usersByUsername ??= new Map());
const sessions: Map<string, MemSession> =
  (globalThis.__synkron_sessions ??= new Map());
const aiUsage: Map<string, { count: number; weekStart: number }> =
  (globalThis.__synkron_aiUsage ??= new Map());
